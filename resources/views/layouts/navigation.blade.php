        ...
        <div class="flex justify-between h-16">
            ...
            @guest
                <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 hover:text-gray-900">Acceder</a>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        @guest
            <div class="pt-4 pb-1 border-t border-gray-200 px-4">
                <a href="{{ route('login') }}" class="block text-gray-700 hover:text-gray-900">Acceder</a>
                <a href="{{ route('register') }}" class="block text-gray-700 hover:text-gray-900 mt-1">Registrarse</a>
            </div>
        @endguest
    </div>
</nav>
